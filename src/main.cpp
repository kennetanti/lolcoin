...
uint256 hashGenesisBlock("0xcf19fb8dd85b93693783dff9e3b853e6e641515f6c462eaba562cb2f7f9724c6");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(509134573); // lolcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "lolcoin Signed Message:\n";
...
{
    // lolcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // lolcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 86400; // lolcoin: 3.5 days
static const int64 nTargetSpacing = 30; // lolcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // lolcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // lolcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // lolcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd0cd5c678ab53e8154492b92152e5666b4931071c87951b24d0ddf03011b7c8c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Strictly for the lulz";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("559869baf0e847f9870cb4f8f3f4aac0a3ec35ab5aa703f283898ebd59e4d97c9c4c88ab4d86d7f287748ac339724ec57ea05144ba4be29583edd0db289685ebbb") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1498001085;
        block.nBits    = 509134573;
        block.nNonce   = 3932196615;

        if (fTestNet)
        {
            block.nTime    = 1498001085;
            block.nNonce   = 1431823160;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x14435443bd39f3d3b32bcf0b684dde5d7a4478d30d8431cec7824a8bc1a8fb77"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // lolcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("lolcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("lolcoinMiner : ProcessBlock, block not accepted");
    }
